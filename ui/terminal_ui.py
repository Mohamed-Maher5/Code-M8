...
AGENT_COLORS = {
    ...
    "explorer":     "bright_cyan",
    "coder":        "bright_green",
    "runner":       "bright_yellow",
}
...
# ══════════════════════════════════════════════════════════════════════════════
# THINKING BAR
# Reads agent_status every 80ms — icon and label change automatically
# as loop.py and dispatcher.py call set_agent()
# ══════════════════════════════════════════════════════════════════════════════
...
class ThinkingBar:
    ...
    def _animate(self) -> None:
        while self.running:
            # Read current agent live — updates every 80ms
            # This is what makes the icon change automatically
            try:
            ...
            # Show slow-response warning after 60 seconds
            warning = (
...
class TerminalUI:
    ...
    def _run_turn(self, user_input: str) -> None:
        ...
        # Start bar — it reads agent_status live, no restarts needed
